    ...
    _OP_DEF(opexe_2, "vector-set!",                    3,  3,       TST_VECTOR TST_NATURAL TST_ANY,  OP_VECSET           )
	  _OP_DEF(opexe_2, "make-blob",							         1,  2, 		  TST_NATURAL TST_ANY,				  	 OP_MKBLOB				   )
	  _OP_DEF(opexe_2, "blob-length",							       1,  1,		    TST_BLOB,								  			 OP_BLOBLEN			     )
    ...
    _OP_DEF(opexe_3, "vector?",                        1,  1,       TST_ANY,                         OP_VECTORP          )
		_OP_DEF(opexe_3, "blob?",									 				 1,  1,		  	TST_ANY,								  			 OP_BLOBP				     )
